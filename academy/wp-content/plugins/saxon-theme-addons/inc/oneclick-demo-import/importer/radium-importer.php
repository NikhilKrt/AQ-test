 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
    	...
    	public function intro_html() {
			...
			?>
		 	...
		 	<p>Importing theme demo data is the easiest way to setup your theme. This will
			    allow you to quickly edit everything instead of creating content from scratch. IMPORTANT: Theme required plugins must be installed and activated before demo import. If you need shop demo install WooCommerce plugin first. Check "Server requirements" section below to ensure that your server meets all requirements for a successful import.</p>
			 </div>
			 ...
			 <div class="theme-demo-import-items">
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 ...
					 <input type="radio" name="theme_demo" value="1" checked>Default<br>
					 </div>
					 ...
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-1/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="2">Fincance/Crypto<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/2/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-2/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="3">News/Magazine<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/3/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-3/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="4">Foodie<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/4/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-4/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="5">Games<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/5/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-5/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="6">Freebies<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/6/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-6/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="7">Minimal<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/7/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-7/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="8">Personal<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/8/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-8/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="9">Masonry<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/9/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-9/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="10">Marketing<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/10/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-10/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="11">Christmas<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/11/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-11/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="12">Travel<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/12/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-12/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="13">Fashion<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/13/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-13/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="14">Business<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/14/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-14/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="15">Money<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/15/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-15/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="16">Newspaper<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/16/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-16/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="17">Tech (Dark theme)<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/17/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-17/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
				...
				<!-- Theme demo -->
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="18">Review<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/18/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.wp-preview.com/saxon/saxon-18/" target="_blank">Live preview</a>
					 </div>
				 </div>
				<!-- // Theme demo -->
	    ...
	    public function demo_installer() {
	        ...
	        <h2><?php echo esc_html__('One Click Saxon Theme Demo Data import', 'saxon'); ?></h2>

	        <?php if(get_option( 'saxon_license_key_status', false ) !== 'activated'): ?>

	        <div class="radium-importer-wrap">
		        <div class="theme-important-notice">
			 	<p><?php echo esc_html__('Please register your purchase to get themes updates notifications, import theme demos and get access to premium dedicated support.', 'saxon'); ?></p>

	          	<a href="themes.php?page=saxon_activate_theme" class="button button-hero button-primary"><?php echo esc_html__('Register theme', 'saxon'); ?></a>
	          	<br/><br/>
				</div>
			</div>
