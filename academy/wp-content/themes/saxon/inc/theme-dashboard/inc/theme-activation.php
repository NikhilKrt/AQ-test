			...
			<div class="wrap about-wrap theme-dashboard-wrapper activation-wrapper">
				...
				<div class="theme-activation-wrapper">
                    ...
                    <div class="theme-activation-wrapper">
                      ...
                      <input name="name" type="text" class="activate-theme-name" placeholder="<?php esc_attr_e('Enter your name', 'saxon'); ?>"/><br/>
