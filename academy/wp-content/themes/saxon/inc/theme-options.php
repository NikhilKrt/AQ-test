...
Kirki::add_field( 'saxon_theme_options', array(
    ...
    'label'       => esc_attr__( 'Review rating (%)', 'saxon' ),
    'description' => '',
    'section'     => 'blog',
    'default'     => '1',
    'priority'    => 55,
...
Kirki::add_field( 'saxon_theme_options', array(
    ...
    'label'       => esc_attr__( 'Review rating (%) in post header', 'saxon' ),
    'description' => '',
    'section'     => 'blog_post',
    'default'     => '1',
    'priority'    => 85,
...
function saxon_kirki_warning() {
    ...
    $message_html = '<div class="notice notice-error"><p><strong>WARNING:</strong> Please <a href="'.esc_url( admin_url( 'themes.php?page=install-required-plugins&plugin_status=install' ) ).'">install and activate Saxon Theme Settings (Kirki Customizer Framework)</a> required plugin, <strong>theme settings will not work without it</strong>.</p></div>';
